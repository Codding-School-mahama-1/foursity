    ...
    // Contact form Firebase functionality
    document.getElementById('contact-form').addEventListener('submit', function(e) {
      ...
      // Save to Firebase
      database.ref('contactMessages').push(contactData)
        .then(() => {
    ...
    function showContactMessage(text, type) {
      ...
      messageDiv.className = `mt-4 p-4 rounded-lg ${type === 'success' ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-red-100 text-red-800 border border-red-300'}`;
      ...
      messageDiv.innerHTML = `
        <div class="flex items-center">
          ...
          <button class="ml-auto text-gray-500 hover:text-gray-700" onclick="this.parentElement.parentElement.innerHTML = ''">
